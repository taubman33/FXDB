...
@pedal8.save
@pedal9 = @user.pedals.build(name:'CryBaby', maker:'Dunlop', effect_type:'pitch', effect_subtype:'Wah', notable_users:'Jimi Hendrix, Slash (Guns N Roses), Kirk Hammett (Metallica)',  songs_used_on:'Guns N Roses - Paradise City', photo: 'https://i.imgur.com/4cwbJSQ.jpg')
@pedal9.save
