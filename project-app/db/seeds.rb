...
Song.create!(name:'Seven Nation Army', artist:'The White Stripes', guitarist:'Jack White', pedals_used:['Electro Harmonix Big Muff', 'Digitech Whammy'])
Song.create!(name:'Time', artist:'Pink Floyd', guitarist:'David Gilmour', pedals_used:['Dallas Arbiter Fuzz Face', 'Binson Echorec', 'Shin-El Univibe'])
